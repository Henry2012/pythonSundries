...
#=====================NLTk Toolbox===================================
#====================================================================
def show_taggers(sentence):
    import nltk
    tokens = nltk.word_tokenize(sentence)
    taggers = nltk.pos_tag(tokens)
    
    return taggers

def lemmatization(word, pos='v'):
    import nltk
...
#            if key == 'MapR': print 'M', value
    ...
    def iterable_fmt(self, threshold=200):
...
# 		d14 = DisplayPkl('./test/everstring_corp_info_2_5_2013.pkl')
# 		d14.iterable_fmt()
        
#         d15 = DisplayPkl('D:/PythonStuff/customer_growth/io/comp_id_dict_8_30_2012.pkl')
#         d15.iterable_fmt()
        
        d15 = DisplayPkl('D:/PythonStuff/self_discovery_investor_module/io/featured_string_stat_for_investors_companies_2013_6_4.pkl')
        d15.iterable_fmt()
    ...
    if 0:
        sentence = 'The online travel industry has seen a 15.2 percent increase in its ACSI scores since 2000, the first year they were measured.'
        print show_taggers(sentence)
    ...
    if 0:
        ...
        # - bootstrapped to bootstrap
        words = [
            "add", "adds", "adding", 'added',
            "bootstrapped", "bootstrapping", "bootstrap",
            "climb", "climbing", "climbed",
            "drop", "double", 'decrease', "decline", "dropped", "dropping", "doubling", "doubled", "decreased", "decreasing", "declined", "declining",
            "expand", "extend", "expanding", "expanded", "extending", "extended",
            "fall", "fallen", "falling", "fell",
            "guadruple", "grow", "gain", "grew", "grown", "gained",
            "increase", 
            "pick",
            "rise", "rack", "reach", "raise",
            "skyrocket", "surpass",
            "triple", "top", "topped", "topping",
            "win", "won",
            ]
        for word in words:
            print lemmatization(word, pos='v')